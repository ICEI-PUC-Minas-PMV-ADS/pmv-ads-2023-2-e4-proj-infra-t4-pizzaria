...
const Home = () => {
    ...
    useEffect(() => {
        const getProducts = async () => {
            try {
                const res = await axios.get(`https://server-pizzaria-eixo4.onrender.com/api/products`)
                ...
                <Text style={{ alignSelf: 'center', fontSize: 24, marginTop: 10, fontWeight: 'bold' }}>
                    ...
                    <View style={{ display: "flex", flexDirection: 'row', marginTop: 10, backgroundColor: '#EFE8E8', borderRadius: 10 }}>
                        ...
                        <View style={{ display: "flex", flexDirection: 'column' }}>
                            ...
                            Uma mistura de queijos, como mozzarella, parmesão e provolone, resultando em uma explosão de sabor que derrete na boca.
                            </Text>
                    ...
                    <View style={{ display: "flex", flexDirection: 'row', marginTop: 10, backgroundColor: '#EFE8E8', borderRadius: 10 }}>
                        <Image
                            style={{ height: 190, width: 150, borderRadius: 20 }}
                            source={{ uri: 'https://github.com/walbergomes/imgs-eixo4/blob/main/pizza3.png?raw=true' }} />

                        <View style={{ display: "flex", flexDirection: 'column' }}>
                            <Text style={{ fontSize: 24, marginTop: 5, fontWeight: 'bold' }} >Pepperoni</Text>

                            <Text style={{ width: 200, marginLeft: 8 }} >
                            Coberta com molho de tomate, queijo mozzarella e fatias finas de pepperoni, um salame picante, criando um contraste de sabores e uma explosão de sabor.
                            </Text>
                    ...
                    <View style={{ display: "flex", flexDirection: 'row', marginTop: 10, backgroundColor: '#EFE8E8', borderRadius: 10 }}>
                        ...
                        <View style={{ display: "flex", flexDirection: 'column' }}>
                            <Text style={{ fontSize: 24, marginTop: 5, fontWeight: 'bold' }} >Margherita</Text>

                            <Text style={{ width: 200, marginLeft: 8 }} >
                            Base de massa coberta com molho de tomate, queijo mozzarella fresco e folhas de manjericão, criando uma combinação simples e deliciosa de ingredientes.
                            </Text>
